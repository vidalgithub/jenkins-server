...
resource "aws_instance" "jenkins_instance" {
  ami           = data.aws_ami.custom_ami.id  # Replace with your desired AMI ID. Make sure you package the software of your choice (eg. jenkins and dependencies) n the image.
